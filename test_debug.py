...
def compute_acc():
    ...
    # dirs = [
    #     ('logs/v1.0.1-normal_ocr/Go_2022_53', 'test_files/receipt_data-test_warped/Go_2022_53/label-Go-2022-53.json'),
    #     ('logs/v1.0.1-normal_ocr/BigC_2022_49', 'test_files/receipt_data-test_warped/BigC_2022_49/label-bigC-2022-49.json'),
    #     ('logs/v1.0.1-normal_ocr/Coopmart_CoopXtra_2022_76', 'test_files/receipt_data-test_warped/Coopmart_CoopXtra_2022_76/label-coopmart-coopxtra-2022-76.json'),
    #     ('logs/v1.0.1-normal_ocr/Emart_2022_29', 'test_files/receipt_data-test_warped/Emart_2022_29/label-emart-2022-29.json'),
    #     ('logs/v1.0.1-normal_ocr/GS25_46', 'test_files/receipt_data-test_warped/GS25_46/label-gs25-46.json'),
    #     ('logs/v1.0.1-normal_ocr/Winmart_2022_40', 'test_files/receipt_data-test_warped/Winmart_2022_40/label-winmart-2022-38.json')
    # ]

    dirs = [
        ('logs/v1.0.2-llm_ocr/Go_2022_53', 'test_files/receipt_data-test_warped/Go_2022_53/label-Go-2022-53.json'),
        ('logs/v1.0.2-llm_ocr/BigC_2022_49', 'test_files/receipt_data-test_warped/BigC_2022_49/label-bigC-2022-49.json'),
        ('logs/v1.0.2-llm_ocr/Coopmart_CoopXtra_2022_76', 'test_files/receipt_data-test_warped/Coopmart_CoopXtra_2022_76/label-coopmart-coopxtra-2022-76.json'),
        ('logs/v1.0.2-llm_ocr/Emart_2022_29', 'test_files/receipt_data-test_warped/Emart_2022_29/label-emart-2022-29.json'),
        ('logs/v1.0.2-llm_ocr/GS25_46', 'test_files/receipt_data-test_warped/GS25_46/label-gs25-46.json'),
        ('logs/v1.0.2-llm_ocr/Winmart_2022_40', 'test_files/receipt_data-test_warped/Winmart_2022_40/label-winmart-2022-38.json')
    ]
