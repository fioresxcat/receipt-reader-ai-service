...
class SaleContractNWFInformationExtractor(InformationExtractor):
    instance = None
    
    def __init__(self, common_config, model_config):
        super(SaleContractNWFInformationExtractor, self).__init__(common_config, model_config)
        ...
        self.label_list = [
            ...
            'payment_term',
            'receiver_bank_name',
            'marker_receiver_bank_name',
            'receiver_bank_swift',
            'marker_receiver_bank_swift',
            'receiver_name',
            'marker_receiver_name',
            'receiver_account_number',
            'marker_receiver_account_number',
            'receiver_address'
        ]
    ...
    def get_instance(common_config, model_config):
        if SaleContractNWFInformationExtractor.instance is None:
            SaleContractNWFInformationExtractor.instance = SaleContractNWFInformationExtractor(common_config, model_config)
        return SaleContractNWFInformationExtractor.instance
