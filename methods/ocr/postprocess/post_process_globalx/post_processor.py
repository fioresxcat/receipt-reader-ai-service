...
class PostProcessorGLOBALX(BaseModule):
    def __init__(self, common_config, model_config):
        super(PostProcessorGLOBALX, self).__init__(common_config, model_config)
    ...
    def init_processor(self, config):
        ...
        if config['type'] == 'Quantity_LM':
            return Quantity_LM(max_words=config['max_words'])
