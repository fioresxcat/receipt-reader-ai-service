...
class Product_quantity_LM(Base_LM):
    def __init__(self, max_words):
        super(Product_quantity_LM, self).__init__()
    ...
    def predict(self, key, index, sub_key, char_cands, charset_list):
        word_cands = self.get_word_cands(char_cands, charset_list, k=2, max_word=self.max_words, max_char=5)
