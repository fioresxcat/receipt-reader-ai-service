...
class PostProcessorGUARDIAN(BaseModule):
    def __init__(self, common_config, model_config):
        super(PostProcessorGUARDIAN, self).__init__(common_config, model_config)
    ...
    def init_processor(self, config):
        ...
        elif config['type'] == 'Product_quantity_LM':
            return Product_quantity_LM(config['max_words'])
