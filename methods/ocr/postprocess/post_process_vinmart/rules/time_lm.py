...
class Time_LM(Base_LM):
    ...
    def check_rule_vinmart(self, word_cands):
        words = []
        raw_words = []
    ...
    def predict(self, key, index, sub_key, char_cands, charset_list):
        word_cands = self.get_word_cands(char_cands, charset_list, k=5, max_word=self.max_words, max_char=20)
        result = self.check_rule_vinmart(word_cands)
