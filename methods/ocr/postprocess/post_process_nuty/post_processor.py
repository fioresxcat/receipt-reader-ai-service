...
class PostProcessorNUTY(BaseModule):
    def __init__(self, common_config, model_config):
        super(PostProcessorNUTY, self).__init__(common_config, model_config)
    ...
    def predict(self, request_id, info):
        ...
        # postprocess time in date
        if 'time' in result['result'].keys() and result['result']['time'] == '' and 'date' in result['result'].keys() and result['result']['date'] != '':
