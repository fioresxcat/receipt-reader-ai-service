...
class PostProcessorHEINEKEN2024(BaseModule):
    def __init__(self, common_config, model_config):
        super(PostProcessorHEINEKEN2024, self).__init__(common_config, model_config)
    ...
    def init_processor(self, config):
        ...
        # elif config['type'] == 'Product_Original_Price_LM':
        #     return Product_Original_Price_LM(config['max_words'])
