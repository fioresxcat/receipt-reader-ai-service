...
class LongOCR(BaseOCR):
    instance = None
    
    def __init__(self, common_config, model_config):
        super(LongOCR, self).__init__(common_config, model_config)
        
        
    @staticmethod
    def get_instance(common_config, model_config):
        if LongOCR.instance is None:
            LongOCR.instance = LongOCR(common_config, model_config)
        return LongOCR.instance
